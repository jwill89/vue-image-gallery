...
<template>
  <article class="message is-info">
    ...
    <div class="message-body">
      <p class="mb-3">
        Tags have categories they belong to, each with a different color. When adding a tag, prefix
        it with a shortcode and colon to assign it to the appropriate category (e.g.
        <code>a:artist name</code>). Tags are converted to lowercase.
      </p>
